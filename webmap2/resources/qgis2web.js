...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1351336.656365, 6967968.800838, -545241.965476, 7263494.539482], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-1351336.656365, 6967968.800838, -545241.965476, 7263494.539482], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Hydrography and Shore Angling Site Distribution in Western Ireland – A GIS-Based Spatial Analysis</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (276 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map visualizes the hydrographic network, angling site locations, and river basin districts in western Ireland. The GIS layers support spatial analysis of aquatic habitats, site accessibility, and regional water management, with contextual basemap data from OpenStreetMap.';
            }
