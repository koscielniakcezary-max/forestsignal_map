...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-727571.888906, 7026302.007329, -726775.800031, 7026942.284734], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-727571.888906, 7026302.007329, -726775.800031, 7026942.284734], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Inventory Map – Sample Plot with Tree Data</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (216 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map shows a sample plot with tree diameter measurements (DBH). Each point represents an individual tree, grouped by diameter class. The data supports forest structure analysis and spatial variability assessment.';
            }
