...
map.getView().fit([-727197.098152, 7026604.681145, -727156.225575, 7026675.629969], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sample9trees</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (37 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Trees 9 sample area in the stand 2025';
            }
