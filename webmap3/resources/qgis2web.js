...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-10.695792, 52.424720, -5.755614, 54.330077], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-10.319421, 52.949394, -7.966955, 53.720283],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-10.695792, 52.424720, -5.755614, 54.330077], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Afforestation and Windthrow Damage in county Galway</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (439 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This interactive map presents private afforestation, windthrow damage, and forest regeneration in County Galway. It includes layers for privately afforested lands, windthrow risk and damage zones, regeneration areas, and the administrative boundary of Galway. The wind damage layer reflects impacts from Storm Éowyn (2025), which brought record-breaking gusts of up to 183 km/h. The map was developed in QGIS and published using qgis2web. ';
            }
