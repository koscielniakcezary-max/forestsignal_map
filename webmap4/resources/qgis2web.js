...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1156267.506166, 6898738.340402, -727814.890783, 7175180.223016], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-1156267.506166, 6898738.340402, -727814.890783, 7175180.223016], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Forests of County Galway in the Context of Climate Change Forestry (CCF) and Designated Natural Heritage Areas (NHA)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (582 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map displays the distribution of coniferous (CLC 311) and broadleaved forests (CLC 312) within County Galway, based on CORINE Land Cover 2018 data (, EPSG:2157). Forest features were spatially filtered using the Galway boundary and overlaid with the  layer, representing legally designated Natural Heritage Areas (NHA).<br />The purpose of this map is to identify forested areas that may contribute to Climate Change Forestry (CCF) strategies, particularly in terms of:<br />• habitat protection,<br />• landscape resilience to climate impacts,<br />• integration with existing conservation zones.';
            }
