...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-10.469115, 52.207313, -7.829574, 54.559681], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-10.319421, 52.948461, -7.966955, 53.722091],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-10.469115, 52.207313, -7.829574, 54.559681], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Spatial Distribution of Wind-Related Forest Risk in Galway</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (403 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map illustrates the spatial distribution of wind-related risk affecting private forests in County Galway. Based on the intersection of recorded wind damage zones and forest locations, the analysis identifies areas with varying levels of exposure. The visual classification supports environmental monitoring, risk mitigation planning, and public awareness of forest vulnerability in western Ireland.';
            }
